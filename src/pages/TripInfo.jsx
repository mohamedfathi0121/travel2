...
const TripInfo = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6" style={{ color: "var(--color-text-primary)" }}>
      <button onClick={() => navigate(-1)} className="underline mb-4 text-sm" style={{ color: "var(--color-btn-primary)" }}>
        ← Back
      </button>
      ...
      {/* Rating Summary */}
      <div className="p-6 rounded shadow mb-10" style={{ backgroundColor: "var(--color-background)" }}>
          ...
          <div className="flex-1 space-y-2">
            {ratingsData.map((r) => (
              <div key={r.stars} className="flex items-center gap-2">
                ...
                <span className="w-10 text-right text-sm" style={{ color: "var(--color-text-secondary)" }}>
                  {r.percent}%
                </span>
              </div>
            ))}
      ...
      <form
        ...
        className="space-y-4 rounded shadow p-6"
        style={{ backgroundColor: "var(--color-background)" }}
      >
        ...
        <input
          ...
          style={{ backgroundColor: "var(--color-input)", color: "var(--color-text-primary)" }}
        />
